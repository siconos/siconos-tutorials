...
if(NOT CTEST_BUILD_NAME)
  ...
  file(READ ../siconos-commit-number.txt SICO_REF)
  string(STRIP ${SICO_REF} SICO_REF)
  include(${CTEST_SOURCE_DIRECTORY}/cmake/SiconosVersion.cmake)
  include(${SICONOS_INSTALL_DIR}/share/siconos/cmake/siconosConfig.cmake)
  set(CTEST_BUILD_NAME "Siconos examples (${SICONOS_VERSION}-devel, ref commit : ${SICO_REF})")
  if(HAS_BULLET)
    set(CTEST_BUILD_NAME "${CTEST_BUILD_NAME} - Bullet ON")
  endif()
  if(SICONOS_HAS_OCE)
    set(CTEST_BUILD_NAME "${CTEST_BUILD_NAME} - With OCE")
  endif()
  if(EXTRA_NAME)

#ifndef MODELISOCHORE_HPP
#define MODELISOCHORE_HPP

#include "Model.hpp"
#include "ThermoLawsPT.hpp"

class ModelNoWallIsochore: public Model
{
    ...
    typedef struct
    {
        ...
        double Qext2;
        double maxTotVolume; // Fixed Pressure (= P(0) in isobar case)

...
ModelNoWallIsobar::ModelNoWallIsobar(){
    ...
    constants.Qext2 = 0;
    constants.Pext = 0; // Fixed Pressure (= P(0) in isobar case)

}

void ModelNoWallIsobar::display_model_state(double h, int iteration){
    Model::display_model_state(h,iteration);

    std::cout << "Using Model ISOBAR WITH NO WALL \n" << std::endl;
}

int ModelNoWallIsobar::initialize_model(double P0, double M10, double x10, double T10,
...
void ModelNoWallIsobar::set_ExternalHeatExchange(double xqext1, double xqext2, double qext1,
...
double ModelNoWallIsobar::massCond(const double &M_, const double &x_){
    return constants.Ccond*M_*(1-x_);
} 
double ModelNoWallIsobar::massConddx(const double &M_, const double &x_){
    return -1.0*constants.Ccond*M_;
} 
double ModelNoWallIsobar::massConddM(const double &M_, const double &x_){
    return constants.Ccond*(1-x_);
} 


/* Model of evaporatation mass transfert */
double ModelNoWallIsobar::massEvap(const double &M_, const double &x_){
    return constants.Cvap*M_*x_;
} 
double ModelNoWallIsobar::massEvapdx(const double &M_, const double &x_){
    return constants.Cvap*M_;
} 
double ModelNoWallIsobar::massEvapdM(const double &M_, const double &x_){
    return constants.Cvap*x_;
} 


/* Model of condensation energy transfert */
double ModelNoWallIsobar::energCond(const double &M_, const double &x_, const double &h_){
    return constants.Ccond*h_*M_*(1-x_);
}
double ModelNoWallIsobar::energConddM(const double &M_, const double &x_, const double &h_){
    return constants.Ccond*h_*(1-x_);
}
double ModelNoWallIsobar::energConddx(const double &M_, const double &x_, const double &h_){
    return -1.0*constants.Ccond*h_*M_;
}
double ModelNoWallIsobar::energConddh(const double &M_, const double &x_, const double &h_){
    return constants.Ccond*M_*(1-x_);
}

/* Model of evaportation energy transfert */
double ModelNoWallIsobar::energEvap(const double &M_, const double &x_, const double &h_){
    return constants.Cvap*h_*M_*x_;
}
double ModelNoWallIsobar::energEvapdM(const double &M_, const double &x_, const double &h_){
    return constants.Cvap*h_*x_;
}
double ModelNoWallIsobar::energEvapdx(const double &M_, const double &x_, const double &h_){
    return constants.Cvap*h_*M_;
}
double ModelNoWallIsobar::energEvapdh(const double &M_, const double &x_, const double &h_){
    return constants.Cvap*M_*x_;
}
...
double ModelNoWallIsobar::energIn(const double & M_,const double & Q_){
    return M_*Q_;
}
double ModelNoWallIsobar::energIndM(const double & M_,const double & Q_){
    return Q_;
}
...
/* Model of external energy transfert  - Constant = Qext 
   ...
   TODO Add other external interaction 
*/
double ModelNoWallIsobar::energIn1(const double & x_,const double & Q_){
    return x_*Q_;
}
double ModelNoWallIsobar::energIn1dx(const double & x_,const double & Q_){
    return Q_;
}

double ModelNoWallIsobar::energIn2(const double & x_,const double & Q_){
    return (1.0-x_)*Q_;
}
double ModelNoWallIsobar::energIn2dx(const double & x_,const double & Q_){
    return -1.0*Q_;
}
...
double ModelNoWallIsobar::tempConduc_1_2(const double &T1_, const double &T2_){
    return constants.Kvl*(T1_-T2_);
}
double ModelNoWallIsobar::tempConduc_1_2dT1(const double &T1_, const double &T2_){
    return constants.Kvl;
}
double ModelNoWallIsobar::tempConduc_1_2dT2(const double &T1_, const double &T2_){
    return -1.0*constants.Kvl;
}

/* Volume equation of mixture */
double ModelNoWallIsobar::volMix(const double &rl_, const double &rv_, const double &M_, const double &x_){
    return x_*laws->vol(rv_,M_) + (1.0-x_)*laws->vol(rl_,M_);
}
double ModelNoWallIsobar::volMixdrl(const double &rl_, const double &rv_, const double &M_, const double &x_){
    return (1.0-x_)*laws->voldr(rl_,M_);
}
double ModelNoWallIsobar::volMixdrv(const double &rl_, const double &rv_, const double &M_, const double &x_){
    return x_*laws->voldr(rv_,M_);
}
double ModelNoWallIsobar::volMixdM(const double &rl_, const double &rv_, const double &M_, const double &x_){
    return x_*laws->voldM(rv_,M_) + (1.0-x_)*laws->voldM(rl_,M_);
}
double ModelNoWallIsobar::volMixdx(const double &rl_, const double &rv_, const double &M_, const double &x_){
    return laws->vol(rv_,M_) - laws->vol(rl_,M_);
}


/* specific internal energy of mixture */ 
double ModelNoWallIsobar::uMix(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
    return x_*laws->u(P_,hv_,rv_) + (1.0-x_)*laws->u(P_,hl_,rl_);
}
double ModelNoWallIsobar::uMixdhl(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
    return (1.0-x_)*laws->udh(P_,hl_,rl_);
}
double ModelNoWallIsobar::uMixdhv(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
    return x_*laws->udh(P_,hv_,rv_);
}
double ModelNoWallIsobar::uMixdrl(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
    return (1.0-x_)*laws->udr(P_,hl_,rl_);
}
double ModelNoWallIsobar::uMixdrv(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
    return x_*laws->udr(P_,hv_,rv_);
}
double ModelNoWallIsobar::uMixdP(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
    return x_*laws->udP(P_,hv_,rv_) + (1.0-x_)*laws->udP(P_,hl_,rl_);
}
double ModelNoWallIsobar::uMixdx(const double &hl_, const double &hv_, const double &rl_, const double &rv_, const double &P_, const double &x_){
...
*/   
void ModelNoWallIsobar::doubleMixtureRHS(double* z_, double* rhs){
    ...
    /////// EXTERNAL /////////
    rhs[isoP_eq] = constants.Pext;                  // Fixed pressure
...
void ModelNoWallIsobar::doubleMixtureRHS_Jacobian(double* z_, NumericsMatrix* rhs_jac){
...
*/   
void ModelNoWallIsobar::doubleMixtureLHS(void* env, FiniteDifference* diffMethod, double* z_, double* lhs){
    ...
    /////// EXTERNAL /////////
    lhs[isoP_eq] = z_[P];  // Fixed pressure
...
*/
void ModelNoWallIsobar::doubleMixtureLHS_Jacobian(void* env, FiniteDifference* diffMethod, double* z_, NumericsMatrix* lhs_jac){
    ...
    /////// EXTERNAL /////////
    lhs_jac->matrix0[M2Ac(isoP_eq,P,nb_vars)] = 1.0;  // Fixed pressure

...
int main(int argc, char* argv[])
{
    try
    {
        ...
        double x1_0     = -5.0;         // initial condition in state variable x1
        double x2_0     = 6.0;          // initial condition in state variable x2
        ...
        osnspb->numericsSolverOptions()->iparam[0]=1; // 1 for multiple solutions,
                                                      // 0 else .
        osnspb->numericsSolverOptions()->iparam[4]=1; // 1 if useDGELS 
        // osnspb->numericsSolverOptions()->iparam[3]=1;
        ...
        while (s->hasNextEvent())
        {
            ...
            cout << "# of solutions: " 
                 << osnspb->numericsSolverOptions()->iparam[2] << endl;

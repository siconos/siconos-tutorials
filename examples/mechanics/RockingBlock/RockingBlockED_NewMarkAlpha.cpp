...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    SP::LagrangianLinearTIDS RockingBlock(
        new LagrangianLinearTIDS(PosIniBlock, VelIniBlock, Mass));
    ...
    */
    ...
    //================================================================================================================
    SP::NonSmoothDynamicalSystem RoBlockModel(
        new NonSmoothDynamicalSystem(TimeInitial, TimeFinal));
    ...
    if ((error = ioMatrix::compareRefFile(DataPlot, "RockingBlockED_NewMarkAlpha.ref", eps,
                                          index)) >= 0.0 &&
        error > eps)
      return 1;
    return 0;

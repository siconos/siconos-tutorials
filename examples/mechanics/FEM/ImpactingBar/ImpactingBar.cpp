...
#include "UserDefinedParameter-ref.hpp"
    ...
    *SparseStiffness *= E * S / l;
    ...
    SP::TimeSteppingDirectProjection s(
        new TimeSteppingDirectProjection(impactingBar, t, OSI, osnspb, position, 0));
    ...
    SP::TimeSteppingCombinedProjection s(
        new TimeSteppingCombinedProjection(impactingBar, t, OSI, osnspb, position, 2));
    ...
    if ((error = ioMatrix::compareRefFile(dataPlot, "ImpactingBar.ref", eps)) >= 0.0 &&
        error > eps)
      return 1;
